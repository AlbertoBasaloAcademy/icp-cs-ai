...
1. **Capture inputs**:
  ...
  - Identify the repo remote URL from Context or [copilot-instructions.md](copilot-instructions.md). 
  - If not, identify it by using local git commands to get the remote URL.
    - Save the remote URL at [copilot-instructions.md](copilot-instructions.md) for later use.
